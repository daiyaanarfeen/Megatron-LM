...
#SBATCH --job-name=a8b_120b_latentmoe_1t_dummy_approach_a_nccl_healthy_8_8_noopt
...
NAME="a8b_120b_latentmoe_1t_dummy_approach_a_nccl_healthy_8_8_noopt"
...
options=" \
    ...
    --nonuniform-ep-num-tp-cp-per-replica 8 8 \
    \
    --log-interval 1 \
