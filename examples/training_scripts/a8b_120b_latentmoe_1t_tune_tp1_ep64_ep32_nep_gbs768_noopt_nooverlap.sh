...
#SBATCH --job-name=a8b_120b_latentmoe_1t_tune_tp1_ep64_ep32_nep_gbs768_noopt_nooverlap_seg16alloc32
...
NAME="a8b_120b_latentmoe_1t_tune_tp1_ep64_ep32_nep_gbs768_noopt_nooverlap_seg16alloc32"
...
options=" \
    ...
    --nonuniform-ep-num-tp-cp-per-replica 64 32 \
