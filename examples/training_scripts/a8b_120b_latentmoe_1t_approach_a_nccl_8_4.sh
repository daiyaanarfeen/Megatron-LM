...
#SBATCH --job-name=a8b_120b_latentmoe_1t_dummy_approach_a_nccl_nep_8_4_noopt
...
NAME="a8b_120b_latentmoe_1t_dummy_approach_a_nccl_nep_8_4_noopt"
...
options=" \
    ...
    --nonuniform-ep-num-tp-cp-per-replica 8 4 \
    \
    --log-interval 1 \
