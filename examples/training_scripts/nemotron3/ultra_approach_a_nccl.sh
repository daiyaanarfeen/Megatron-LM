...
#SBATCH --job-name=nemotron3_ultra_dp1_dummy_approach_a_nccl
...
NAME="nemotron3_ultra_dp1_dummy_approach_a_nccl"
...
options=" \
    ...
    --nonuniform-ep-num-tp-cp-per-replica 8 8 8 8 8 8 8 8 \
    \
    --log-interval 1 \
