...
The default NEP DDP approach is `p2p`, which transfers expert gradients to owner
ranks before owner-side EDP sync and scatter-back. To run the historical Approach
A NCCL baseline instead, add:
