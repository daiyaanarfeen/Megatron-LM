...
# Run each test in a separate torchrun to avoid NCCL state corruption
# across destroy_model_parallel/reinit cycles.
run_test 'TestApproachB_12GPU and test_grad_sync_sum' 29500

echo "=== ALL 12-GPU TESTS COMPLETE ==="
