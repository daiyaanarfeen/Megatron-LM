...
CASE_BUCKET_READY_GATHER="${CASE_BUCKET_READY_GATHER:-0}"
CASE_DEVICE_ORDERED_EDP="${CASE_DEVICE_ORDERED_EDP:-0}"
CASE_PARALLEL_GATHER_WINDOW="${CASE_PARALLEL_GATHER_WINDOW:-1}"
CASE_SKIP_OWNER_GRAD_CHECK="${CASE_SKIP_OWNER_GRAD_CHECK:-1}"
CASE_EXPERT_BUCKET_GROUPS="${CASE_EXPERT_BUCKET_GROUPS:-3}"
CASE_ASYNC_CHUNK_WINDOW="${CASE_ASYNC_CHUNK_WINDOW:-16}"
...
run_case() {
    ...
    timeout --foreground --signal=TERM --kill-after=45s "${CASE_TIMEOUT}" \
        env \
            ...
            MEGATRON_NONUNIFORM_EP_BUCKET_READY_GATHER="${CASE_BUCKET_READY_GATHER}" \
            MEGATRON_NONUNIFORM_EP_DEVICE_ORDERED_EDP="${CASE_DEVICE_ORDERED_EDP}" \
            ...
            MEGATRON_NONUNIFORM_EP_PARALLEL_GATHER_WINDOW="${CASE_PARALLEL_GATHER_WINDOW}" \
            ...
            MEGATRON_NONUNIFORM_EP_NCCL_ASYNC_CHUNK_WINDOW="${CASE_ASYNC_CHUNK_WINDOW}" \
            MEGATRON_NONUNIFORM_EP_NCCL_EXPERT_BUCKET_GROUPS="${CASE_EXPERT_BUCKET_GROUPS}" \
