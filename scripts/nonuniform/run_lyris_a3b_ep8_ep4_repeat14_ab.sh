...
# Two-repeat original-pattern healthy versus ordered NEP profiler comparison.
...
#SBATCH --job-name=coreai_comparch_sysarch-nep.a3b-ep8-4-repeat14-ab

set -euo pipefail

REPO_DIR="${REPO_DIR:-/home/darfeen/Megatron-LM}"
export REPO_DIR
export ROOT_DIR="${ROOT_DIR:-${REPO_DIR}/slurm_runs/lyris_a3b_ep8_ep4_repeat14_ab}"
export CASE_LABEL="repeat14"
export CASE_HYBRID_LAYER_PATTERN="MEMEM*EMEMEM*E"
export CASE_SELECTION="healthy_split"
export CASE_TRAIN_ITERS="10"
export CASE_TIMEOUT="10m"
export CASE_EXIT_DURATION_IN_MINS="9"
