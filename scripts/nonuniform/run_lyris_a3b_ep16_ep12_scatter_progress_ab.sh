...
SCATTER_CHUNKS="${SCATTER_CHUNKS:-4}"
...
echo "[ep16-12-scatter] seq=${SEQ_LENGTH} experts=${NUM_EXPERTS} topk=${MOE_ROUTER_TOPK} full_mbs=${FULL_MICRO_BATCH_SIZE} reduced_mbs=${REDUCED_MICRO_BATCH_SIZE} healthy_gbs=${healthy_true_gbs} nep_gbs=${nep_true_gbs} scatter_chunks=${SCATTER_CHUNKS}"
